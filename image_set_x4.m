...
for i=1:281
    t1=clock;
    s1=sprintf("F:\\Final year project\\Test images\\PreFACE raw data stacks\\episcopic_4x_RFtarget\\_AfBmpB_%d_%dum.png",i+139, defocus_length(i));
    s2=sprintf("F:\\Final year project\\Test images\\PreFACE raw data stacks\\episcopic_4x_RFtarget\\_AfBmpA_%d_%dum.png",i+139, defocus_length(i));
    image1 = imread(s1);
    image2 = imread(s2);
